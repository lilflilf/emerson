...
//                            z:10
                            ...
                            onEntered: {
//                                tempText.color = "red"
                                tempText.newObject = Qt.createQmlObject('import QtQuick 2.7;Rectangle {color: "#052a40";property alias mytext: tempText.text;height: tempText.height;width:tempText.width;z:11; Text {id: tempText;anchors.verticalCenter: parent.verticalCenter;text: qsTr("")
