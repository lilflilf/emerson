...
public:
    ...
    QString FormatedDataToString(enum ScreenShowDataType TypeIndex, double Data);
    ...
    double StringToFormatedData(enum ScreenShowDataType TypeIndex, QString ShownData);
